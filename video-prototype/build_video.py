...
SCENES = [
    ...
    },
    {
        ...
        "visual": {"type": "bullets", "kicker": "分析パイプライン",
                   "title": "延べ251個 → 41種類",
                   "items": ["抽出できた主張(延べ): 251個 / 1冊あたり平均8.4個",
                             "同じ意味をまとめると: 41種類",
                             "20冊以上に登場したもの: たった3種類"]},
        "lines": [
            {"sp": "mei", "text": "抽出できた主張は、延べで251個",
             "tts": "抽出できた主張は、のべで、にひゃくごじゅういっこ"},
            {"sp": "noa", "text": "1冊あたり8個ちょっとですね",
             "tts": "いっさつあたり、はちこちょっとですね"},
            {"sp": "mei", "text": "同じ意味のものをまとめたら、41種類まで減ったわ",
             "tts": "同じ意味のものをまとめたら、よんじゅういっしゅるいまで減ったわ"},
            {"sp": "noa", "text": "30冊で41種類…けっこう被ってるんですね",
             "tts": "さんじゅっさつでよんじゅういっしゅるい。けっこう被ってるんですね"},
            {"sp": "mei", "text": "そう。そのうち20冊以上に登場したのは、たった3種類",
             "tts": "そう。そのうちにじゅっさつ以上に登場したのは、たったさんしゅるい"},
    ...
    },
    {
        ...
        "visual": {"type": "bars", "kicker": "もうひとつの発見",
                   "title": "和書と洋書できれいに逆転した",
                   "items": [("「記録する」洋書", 14, 14),
                             ("「記録する」和書", 3, 16),
                             ("「まとめて処理」洋書", 5, 14),
                             ("「まとめて処理」和書", 16, 16)]},
        "lines": [
            {"sp": "mei", "text": "もうひとつ、面白い差が出たわ。洋書14冊、和書16冊で比べたの",
             "tts": "もうひとつ、面白い差が出たわ。洋書じゅうよんさつ、和書じゅうろくさつで比べたの"},
            {"sp": "mei", "text": "「時間を記録する」は、洋書14冊すべてに出てきたわ",
             "tts": "時間を記録するは、洋書じゅうよんさつすべてに出てきたわ"},
            {"sp": "noa", "text": "全部ですか!?"},
            {"sp": "mei", "text": "ところが和書だと、16冊中3冊だけ",
             "tts": "ところが和書だと、じゅうろくさつちゅう、さんさつだけ"},
            {"sp": "noa", "text": "えっ、そんなに差があるんですか"},
            {"sp": "mei", "text": "逆に「似た作業をまとめて処理」は、和書16冊すべてに出てきたの",
             "tts": "逆に、似た作業をまとめて処理は、和書じゅうろくさつすべてに出てきたの"},
            {"sp": "mei", "text": "洋書だと14冊中5冊。きれいに逆転しているわ",
             "tts": "洋書だとじゅうよんさつちゅう、ごさつ。きれいに逆転しているわ"},
            {"sp": "noa", "text": "同じ時間術なのに、前提が違うみたいです"},
            {"sp": "mei", "text": "洋書は「まず測れ」、和書は「まず整えろ」。そんな違いね"},
        ],
    },
    # ---- POINT 3 -----------------------------------------------------------
    {
